...
export const generateAiReporter = async ({month}: GenerateAiReporterSchema) => {
    ...
    if (!hasPremiumPlan) {
        throw new Error("You need a premium plan to generate AI repots.")
    }
    ...
    com dicas e orientações de como melhorar minha vida financeira. As transações estão divididas por ponto e vírgula. 
