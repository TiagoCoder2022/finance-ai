...
import { generateAiReporter } from "../_actions/generate-ai-reporter";
...
const AiReportButton = ({month}: AiReportButtonProps) => {     
    ...
    const handleGenerateReportClick = async () => {
        try {
            ...
            const aiReport = await generateAiReporter({month})
            setReport(aiReport)
        } catch (error) {
            console.error(error)
        } finally {
        ...
        <Dialog>
            ...
            <DialogContent className="max-w-[600px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Use inteligência artificial para gerar relatório com insughts
                        sobre suas finanças.
                    </DialogDescription>
                </DialogHeader>
